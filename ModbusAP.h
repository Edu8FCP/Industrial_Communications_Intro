...
#define APDU_MAX 253 // Application Layer max - estava no documento
#define PORTO_MIN 0
...
// A dos write tem tamanho variável

// MODBUS Exception Responses (cap.7)
...
#define SERVER_DEVICE_FAILURE           -104
